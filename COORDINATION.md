...
| lq8fNVME8v | Minimum Distance Summaries for Robust Neural Posterior Estimation | autoloop | in_progress | | | 2026-07-16 | Selected as a proven high-quality 8/8 CPU target (four claims; 5.77 s reference core run). Scope: frozen neural NPE hashes, official 512-RFF adapter, Gaussian and OUP robustness trials, timing/approximation checks, proof dependency audit, severe-contamination boundary, and fail-closed tests. |
