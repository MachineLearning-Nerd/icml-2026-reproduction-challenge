...
| DKathyl3XN | On Structured State-Space Duality | autoloop | in_progress | | | 2026-07-16 | Selected as a proven high-quality 6/6 CPU target (<20 s reference). Scope: released-code diagonal SSM equivalence, independent recurrence/materialization checks, linear-vs-quadratic timing, richer-dynamics rank certificate, and both directions of the 1-semiseparable equivalence criterion. |
