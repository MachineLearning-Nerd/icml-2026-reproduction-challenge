...
| uYWVGk1Qt0 | Towards Understanding Adam Convergence on Highly Degenerate Polynomials | autoloop | claimed | | | 2026-07-16 | Claimed after read-only audit: two claims, exact one-dimensional polynomial model, arbitrary-precision CPU recurrence, analytic rate constants, and high-quality 4/4 precedent. Scope: k=4,6,8,10 Adam/RMSProp/GD/heavy-ball convergence laws; steps-to-precision fits; v_t versus g_t^2 decoupling; effective learning-rate growth; exact/finite-difference Jacobian and phase-boundary controls. |
