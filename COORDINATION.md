...
| lq8fNVME8v | Minimum Distance Summaries for Robust Neural Posterior Estimation | autoloop | under_verdict | DineshAI/lq8fNVME8v | MachineLearning-Nerd/icml26-repro-lq8fNVME8v-mds | 2026-07-16 | Published, public, and tagged at Space commit `a9e77b6`. All 4 claims supported: pinned official 512-RFF adapter; frozen Gaussian and OUP neural NPEs with unchanged state hashes; 91.46% and 69.11% mean RMSE reductions; exact robustness/consistency assumption audit; severe-contamination controls. All 12 prospective gates and 16 tests pass. Full timing, including slower local OUP latency, is disclosed. Awaiting judge; expected 8/8. |
