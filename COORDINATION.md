...
| MdHcU4C4Rm | Optimal Unconstrained Self-Distillation in Ridge Regression: Strict Improvements, Precise Asymptotics, and One-Shot Tuning | autoloop | under_verdict | DineshAI/MdHcU4C4Rm | MachineLearning-Nerd/icml26-repro-MdHcU4C4Rm-self-distillation | 2026-07-16 | Published, public, and tagged at Space commit `b6f0d9b`. Claim 1 is independently falsified as written by 64/64 nondegenerate stationary counterexamples, while the corrected theorem passes 1,408/1,408 nonstationary checks. Claims 2-3 supported by 737 negative optima, perfect sign rule, exact lambda*=0.5 transition, and 288 one-shot fits through p=400 with decreasing weight/regret errors. Dense brute-force argmins agree; 7 tests pass; full run 4.17 s CPU. Awaiting judge; expected high-quality 6/6. |
