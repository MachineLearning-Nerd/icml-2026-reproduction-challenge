...
| MvuCgK0Qns | Softmax as Linear Attention in the Large-Prompt Regime: a Measure-based Perspective | autoloop | claimed | | | 2026-07-16 | Claimed after read-only audit: three CPU-native claims, exact Gaussian affine identity, analytic output/U/V Jacobians, concentration scaling, and small-dimensional optimization; official code at `8fa49b3`; prior high-quality 6/6 precedent. Scope: clean-room Gauss-Hermite/Monte Carlo identity checks, Gaussian covariance families, Rademacher negative control, exact Jacobian and gradient-trajectory stability, and optimization/Bayes-transfer checks with fail-closed tests. |
