...
| MdHcU4C4Rm | Optimal Unconstrained Self-Distillation in Ridge Regression: Strict Improvements, Precise Asymptotics, and One-Shot Tuning | autoloop | claimed | | | 2026-07-16 | Claimed after read-only audit: three claims, exact CPU-native population risks, released code, and prior high-quality 6/6 reproductions. Scope: independently falsify Claim 1 as written at nondegenerate stationary penalties while verifying its corrected nonstationary theorem; verify negative optimal weights and sign transition; verify one-shot GCV consistency across proportional scales; cross-check closed forms, brute force, asymptotics, and fail-closed controls. |
