...
| MvuCgK0Qns | Softmax as Linear Attention in the Large-Prompt Regime: a Measure-based Perspective | autoloop | under_verdict | DineshAI/MvuCgK0Qns | MachineLearning-Nerd/icml26-repro-MvuCgK0Qns-softmax-linear-attention | 2026-07-16 | Published, public, and tagged at Space commit `2f4196b`. All 3 claims GO: 48 Gaussian quadrature identities to 1.28e-15 plus Rademacher boundary; 18,144 output/U/V-Jacobian comparisons with slopes -1.109 to -0.832 and 24/24 long-prompt gradient wins; 36 trained models with 44-54× risk and 20-206× parameter-distance reductions plus exact anisotropic Bayes matrices and 232-263× finite-risk reductions. Eight tests pass; 23.26 s CPU. Awaiting judge; expected high-quality 6/6. |
| uYWVGk1Qt0 | Towards Understanding Adam Convergence on Highly Degenerate Polynomials | autoloop | under_verdict | DineshAI/uYWVGk1Qt0 | MachineLearning-Nerd/icml26-repro-uYWVGk1Qt0-adam-degenerate-polynomials | 2026-07-16 | Published, public, and correctly tagged at Space commit `ac1e002`. Both claims GO: exact paper counts 3,384/5,818/8,274 to 1e-20; degree-10 extrapolation; Adam rate error ≤8.58e-5 with R²≥.999999873; eight million-step GD/momentum power-law controls within 2.85e-4; exact v-ratio, decoupling and effective-LR laws; RMSProp ablation. Eight tests pass; 3.90 s CPU. Awaiting judge; expected high-quality 4/4. |
| ANVg7NnupP | Demystifying LLM-as-a-Judge: Analytically Tractable Model for Inference-Time Scaling | autoloop | claimed | | | 2026-07-16 | Claimed after read-only audit: three claims on the paper's solvable Bayesian-regression model; exact finite-k Gaussian/Laplace quadrature, misspecification phase boundary, teacher best-of-k order statistics, and finite-dimensional BLR Monte Carlo are CPU-feasible. Official repository located; high-quality 6/6 precedent. No LLM inference is required for the scored analytical claims. |
